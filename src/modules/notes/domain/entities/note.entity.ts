...
export class NoteEntity {
  ...
  static createNew(input: { userId: string; lessonId: string; noteText: string; codeSnippet?: string }): NoteEntity {
  ...
  applyPatch(input: { noteText?: string; content?: string; codeSnippet?: string }): void {
