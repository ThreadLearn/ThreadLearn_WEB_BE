...
import {
  ...
  InstructorManagementTargetInput,
...
@Injectable()
export class UnlockInstructorService {
  constructor(@Inject(USER_REPOSITORY) private readonly userRepo: IUserRepository) {}

  async execute(input: InstructorManagementTargetInput): Promise<InstructorManagementResult> {
